const STATIC_CACHE = 'bk-static-v127';
const RUNTIME_CACHE = 'bk-runtime-v127';
...
const CORE_ASSETS = [
  ...
  './styles.css?v=127',
  './box.css?v=127',
  './assets/header/header.css?v=127',
  './assets/cart/cart-drawer.css?v=127',
  './assets/delivery/delivery.css?v=127',
  './assets/vendor/fluid-particles.css?v=127',
  './assets/img/picture.js?v=127',
  './assets/config/config.js?v=127',
  './assets/api/client.js?v=127',
  './entry.js?v=127',
  './app.js?v=127',
  './box.js?v=127',
  './assets/header/header.js?v=127',
  './assets/cart/cart-drawer.js?v=127',
  './assets/i18n/box-i18n.js?v=127',
  './assets/concierge/concierge-ai.js?v=127',
  './assets/vendor/fluid-particles.js?v=127',
  './assets/pwa/register-sw.js?v=127',
