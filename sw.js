const STATIC_CACHE = 'bk-static-v108';
const RUNTIME_CACHE = 'bk-runtime-v108';
...
const CORE_ASSETS = [
  ...
  './styles.css?v=108',
  './box.css?v=108',
  './assets/header/header.css?v=108',
  './assets/cart/cart-drawer.css?v=108',
  './assets/delivery/delivery.css?v=108',
  './assets/vendor/fluid-particles.css?v=108',
  './assets/img/picture.js?v=108',
  './assets/config/config.js?v=108',
  './assets/api/client.js?v=108',
  './entry.js?v=108',
  './app.js?v=108',
  './box.js?v=108',
  './assets/header/header.js?v=108',
  './assets/cart/cart-drawer.js?v=108',
  './assets/i18n/box-i18n.js?v=108',
  './assets/concierge/concierge-ai.js?v=108',
  './assets/vendor/fluid-particles.js?v=108',
  './assets/pwa/register-sw.js?v=108',
