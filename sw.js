const STATIC_CACHE = 'bk-static-v119';
const RUNTIME_CACHE = 'bk-runtime-v119';
...
const CORE_ASSETS = [
  ...
  './styles.css?v=119',
  './box.css?v=119',
  './assets/header/header.css?v=119',
  './assets/cart/cart-drawer.css?v=119',
  './assets/delivery/delivery.css?v=119',
  './assets/vendor/fluid-particles.css?v=119',
  './assets/img/picture.js?v=119',
  './assets/config/config.js?v=119',
  './assets/api/client.js?v=119',
  './entry.js?v=119',
  './app.js?v=119',
  './box.js?v=119',
  './assets/header/header.js?v=119',
  './assets/cart/cart-drawer.js?v=119',
  './assets/i18n/box-i18n.js?v=119',
  './assets/concierge/concierge-ai.js?v=119',
  './assets/vendor/fluid-particles.js?v=119',
  './assets/pwa/register-sw.js?v=119',
