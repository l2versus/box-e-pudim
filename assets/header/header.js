...
(() => {
  ...
  const I18N = {
    en: {
      ...
      boxKickerDrop: 'Drop menu',
      boxMenuTitle: 'Pick the batch before it closes.',
      boxFeatured: 'Featured',
      boxKickerOrder: 'Order cart',
      boxOrderTitle: 'Choose boxes, review the date, then send one clean WhatsApp request.',
    ...
    pt: {
      ...
      boxKickerDrop: 'Cardápio do drop',
      boxMenuTitle: 'Escolha o lote antes que feche.',
      boxFeatured: 'Em destaque',
      boxKickerOrder: 'Carrinho do pedido',
      boxOrderTitle: 'Escolha os boxes, revise a data, e envie um pedido único pelo WhatsApp.',
